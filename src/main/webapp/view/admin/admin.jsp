...
<%@page import="com.webbanhang.connectionDB.ConnectionDB"%>
<%@page import="com.webbanhang.model.Admin"%>
  ...
  <jsp:include page = "./header/header.jsp" flush = "true" /> 
    <div class="content-wrapper"> 
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          <div class="col-lg-12"> 
            <a href="${pageContext.request.contextPath}/view/admin/addadmin.jsp">Thêm Admin</a>
          </div> 
          <div class="col-lg-12"> 
            <div class="card"> 
              <div class="card-body"> 
