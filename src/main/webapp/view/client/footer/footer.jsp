            ...
            <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <a href="${pageContext.request.contextPath}/HomeController1"><img src="${url}/images/logo_footer.jpg" alt="logo img" width="185px"></a> 
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Liên Hệ</h3>
                    <address>
                      <p>  P.Khương Trung - Q.Thanh Xuân  - TP Hà Nội  - CTY THHH nông sản sạch</p>
                      <p><span class="fa fa-phone"></span>037.7026.186</p>
                      <p><span class="fa fa-envelope"></span>webthucphamsach@gmail.com</p>
                    </address>
